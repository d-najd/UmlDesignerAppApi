...
const dist_1 = require("augment-vir/dist");
...
function setResets(internalCommentTriggers) {
    ...
    const setLineCountLineNumbers = (0, dist_1.getObjectTypedKeys)(internalCommentTriggers.setLineCounts);
    ...
    const setWrapThresholdLineNumbers = (0, dist_1.getObjectTypedKeys)(internalCommentTriggers.setWrapThresholds);
