...
function randomString(inputLength = 16) {
    ...
    if (typeof window === 'undefined') {
        throw new Error(`Window not defined for ${randomString.name} function. If using this in a Node.js context, import ${randomString.name} from 'augment-vir/dist/node'`);
    }
    // browser side
    else {
